...
- Illiterate/semi-literate citizens who — even with Bhasha & Bol's voice fill — still need to physically navigate a touchscreen form to submit and review before pressing Submit (Bhasha & Bol explicitly never auto-submits, per `docs/CLAUDE.md`, precisely because a heuristic parse needs human review; someone still has to see and confirm the screen).

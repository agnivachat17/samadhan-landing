            ...
            <div className="mt-8 grid gap-8 lg:grid-cols-[minmax(0,1fr)_minmax(19rem,.6fr)]">
              <article>
                ...
                <p className="mt-5 font-body text-[0.88rem] leading-relaxed text-[#53675d]">
                  Submit the intervention outcome and its primary evidence link.
                  The closeout will move to citizen confirmation and
                ...
                >
                  ...
                  <label className="mt-5 block">
                    ...
                    <input
                      ...
                      placeholder="Optional link to a project document"
                    />
                  </label>
                  <button
                    disabled={submit.isPending || updateProject.isPending}
                    className="rounded-full mt-6 flex items-center gap-2 bg-[#c94a20] px-5 py-4 font-mono-ui text-[0.59rem] font-semibold uppercase tracking-[0.1em] text-white"
                  >
                    <Send size={15} />
                    ...
                    {closeoutsQuery.data?.map(item => (
                      ...
                      >
                        <p className="font-mono-ui text-[0.53rem] uppercase tracking-[0.08em] text-[#64776d]">
                          Citizen: {item.citizenConfirmation} · Admin:{" "}
                          {item.adminStatus}
                        </p>

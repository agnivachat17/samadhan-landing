/**
 * Draggable before/after image reveal slider. Vendored from 21st.dev
 * (ibelick/image-comparison, motion-primitives) — used for USP-07 closeout
 * evidence pairs so citizens/admins can drag to compare before vs. after
 * instead of scanning two static thumbnails side by side.
 */
